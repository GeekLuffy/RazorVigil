"""
RazorShield Sentinel — Attack Simulator
...
async def main(mode: str, burst_n: int, burst_rps: float, slow_workers: int,
    ...
    print(f"\n{_CYAN}{_BOLD}RazorShield Sentinel — Attack Simulator{_RESET}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="RazorShield Sentinel -- Attack Simulator (demo script)"
    )
    parser.add_argument(
