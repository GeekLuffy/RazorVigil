# ⏱️ RazorShield Sentinel — Synchronous Latency Budget & Circuit Breakers

## 1. Gateway SLA Context
Razorpay specifies a **<50ms latency SLA** for synchronous checkout risk evaluation. RazorShield Sentinel executes a complete 7-layer defense and ML pipeline well within this envelope, averaging **9.08ms (p50)** and **13.86ms (p99)** under live high-throughput traffic.
